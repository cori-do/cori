...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            llm_cmd::get_llm_settings,
            llm_cmd::refresh_llm_settings,
            llm_cmd::set_llm_priority,
            llm_cmd::set_llm_backend_enabled,
            llm_cmd::set_llm_backend_model,
            llm_cmd::preview_llm_resolution,
            browse::peek_source,
            browse::list_dir,
